...
class ConnectFourGUI:
    ...
    def on_click(self, col):
        ...
        if self.game.is_valid_location(self.game.board, col):
            ...
            # Drop the player's piece in the board
            ...
            # Blocking AI's turn
            ai_col = bot_move(self.game.board, self.game.AI_PIECE)
            if ai_col is not None and self.game.is_valid_location(self.game.board, ai_col):
